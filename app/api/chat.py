...
from app.db.minio_client import get_minio
...
async def langgraph_agent(request: Request, input_data: RunAgentInput, neo_db=Depends(get_session), rag_minio=Depends(get_minio), code_archive_graph=Depends(get_code_archive_graph)):
    """
